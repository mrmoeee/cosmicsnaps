...
pic = Picture.new(title: 'This is an Astronaut', description: 'Floating through space', user_id: user1.id)
pic.photo.attach(io: File.open('./app/assets/images/astro.jpg'), filename: 'astro.jpg')
pic.save!

pic2 = Picture.new(title: 'This is an Astronaut', description: 'Floating through space', user_id: user2.id)
